...
namespace Cobros.Controllers.Test {
    public class ChargesControllerShould {
        ...
        public async Task given_data_for_add_new_charge_we_obtein_an_ok_response() {
            Charges.Business.Dtos.Charge newCharge = GivenANewCharge();
        ...
        public async Task given_a_new_charge_we_obtein_an_ok_response() {
            ...
            Charges.Business.Dtos.Charge charge = GivenANewCharge();
        ...
        private static Charges.Business.Dtos.Charge GivenANewCharge() {
            return new Charges.Business.Dtos.Charge { Description = "Nuevo cobro", Amount = 1000, identifier = "anyIdentifier" };
        }

        private static HttpContent GivenAHttpContent(Charges.Business.Dtos.Charge charge2, string requestUri) {
